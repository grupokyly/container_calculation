		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Criação de contenedores",
									"targetURL": "#containercalculation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"containercalculation-display": {
								"semanticObject": "containercalculation",
								"action": "display",
								"description": "Criação de contenedores",
								"title": "Criação de contenedores",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=containercalculation",
									"url": sap.ui.require.toUrl("containercalculation")
								}
							}
						}
					}
